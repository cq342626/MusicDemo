 ...
 * �������ֲ���
 */
public class MusicLocalMFragment3 extends Fragment implements OnItemClick {
	
	private RecyclerView mRecyclerView;//�������ֵ��б�
	private MusicLocalAdapter adapter;//������
	private Context context;
	
	private static MusicLocalMFragment3 localFragment = new MusicLocalMFragment3();
	
	
	public static Fragment newInstance() {
		if(localFragment == null)
			localFragment = new MusicLocalMFragment3();
