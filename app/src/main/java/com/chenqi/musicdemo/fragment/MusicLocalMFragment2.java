 ...
 * 本地音乐播放
 */
public class MusicLocalMFragment2 extends Fragment implements OnItemClick {

	private RecyclerView mRecyclerView;//本地音乐的列表
	private MusicLocalAdapter adapter;//适配器
	private Context context;
	
	private static MusicLocalMFragment2 localFragment = new MusicLocalMFragment2();
	
	
	public static Fragment newInstance() {
		if(localFragment == null)
			localFragment = new MusicLocalMFragment2();
